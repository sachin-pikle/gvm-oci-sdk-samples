# OCI Object Storage samples using Netty/Micronaut Serializer
...
```
-rwxr-xr-x  1 user  group    62M Aug 17 14:49 my-app
-rw-r--r--  1 user  group    22M Aug 17 14:45 my-app-1.0-SNAPSHOT-jar-with-dependencies.jar
...
```
