# Netty-based GraalVM Native Image Function that returns a list of instances in a given compartment
...
The name of your function *fn-gvm-oci-list-instances-netty* is specified in [func.yaml](./func.yaml).
...
e.g.
```
echo -n 'ocid1.compartment.oc1...2jn3htfoobar' | fn invoke myapp fn-gvm-oci-list-instances-netty
```
